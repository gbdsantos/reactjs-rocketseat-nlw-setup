...
export function NewHabitForm() {
  ...
  return (
    <form className="w-full flex flex-col mt-6" onSubmit={createNewHabit}>
      ...
      <button
        className="mt-6 rounded-lg p-4 flex items-center justify-center gap-3 font-semibold bg-green-600 hover-bg-green-500 transition-colors focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-zinc-900"
        type="submit"
      >
        <Check
          size={20}
